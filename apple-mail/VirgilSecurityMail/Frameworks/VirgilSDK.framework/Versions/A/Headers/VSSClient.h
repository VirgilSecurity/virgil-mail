...
- (void)verifyIdentityWithType:(VSSIdentityType)type value:(NSString * __nonnull)value extraFields:(NSDictionary  * __nullable)extra completionHandler:(void(^ __nullable)(GUID * __nullable actionId, NSError * __nullable error))completionHandler;
